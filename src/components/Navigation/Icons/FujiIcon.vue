<template>
  <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
    y="0px" viewBox="0 0 512 512" style="width: 24px; height: 24px; opacity: 1;" xml:space="preserve">
    <g>
      <path class="st0"
        d="M389.748,228.263c-14.832-36.272-23.531-85.945-27.031-121.674l-1.226-12.378H150.502l-1.234,12.378
